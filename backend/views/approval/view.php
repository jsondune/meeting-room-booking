                ...
                <ul class="mb-0 small">
                    <?php foreach ($conflicts as $conflict): ?>
                        <li>
                            ...
                            - <?= Yii::$app->formatter->asDate($conflict->booking_date) ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><?= Html::encode($model->department->name ?? '-') ?></p>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <small class="text-muted">
                        จองเมื่อ <?= Yii::$app->formatter->asDatetime($model->created_at) ?>
                    </small>
                </div>
            </div>
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            ...
                            <strong><?= Yii::$app->formatter->asDate($model->booking_date) ?></strong>
                        </li>
                        <li class="mb-2">
