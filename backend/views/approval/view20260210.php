                ...
                <ul class="mb-0 small">
                    <?php foreach ($conflicts as $conflict): ?>
                        <li>
                            ...
                            - <?= Yii::$app->formatter->asDate($conflict->booking_date, 'medium') ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-sm table-borderless">
                                <tr>
                                    ...
                                    <td>
                                        <strong>
                                            <?= Yii::$app->formatter->asDate($model->booking_date, 'long') ?>
                                        </strong>
                                        <?php if ($isToday): ?>
                            ...
                            <tbody>
                                <?php foreach ($userBookings as $booking): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= Yii::$app->formatter->asDate($booking->booking_date, 'short') ?>
                                            <br>
                                            <small class="text-muted">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <small class="text-muted">
                        จองเมื่อ <?= Yii::$app->formatter->asDatetime($model->created_at, 'medium') ?>
                    </small>
                </div>
            </div>
                    ...
                    <div class="card-body text-center">
                        <?php if ($model->status === 'approved'): ?>
                            ...
                            <?php if ($model->approver): ?>
                                ...
                                <small class="text-muted">
                                    <?= Yii::$app->formatter->asDatetime($model->approved_at, 'medium') ?>
                                </small>
                            <?php endif; ?>
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            ...
                            <strong><?= Yii::$app->formatter->asDate($model->booking_date, 'long') ?></strong>
                        </li>
                        <li class="mb-2">
