        ...
        <div class="col-md-6 col-lg-5">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0">
                        <i class="bi bi-key text-primary me-2"></i><?= Html::encode($this->title) ?>
                    </h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <?= $form->field($model, 'current_password')
                            ...
                            ->label('<i class="bi bi-lock me-1"></i> รหัสผ่านปัจจุบัน') ?>
                    </div>
                    ...
                    <div class="mb-3">
                        <?= $form->field($model, 'new_password')
                            ...
                            ->label('<i class="bi bi-key me-1"></i> รหัสผ่านใหม่')
                    ...
                    <div class="mb-4">
                        <?= $form->field($model, 'confirm_password')
                            ...
                            ->label('<i class="bi bi-key-fill me-1"></i> ยืนยันรหัสผ่านใหม่') ?>
                    </div>

                    <div class="d-grid gap-2">
                        <?= Html::submitButton('<i class="bi bi-check-lg me-1"></i> เปลี่ยนรหัสผ่าน', [
                            'class' => 'btn btn-primary btn-lg',
                            'name' => 'change-password-button'
                        ]) ?>
                        
                        <?= Html::a('<i class="bi bi-arrow-left me-1"></i> ยกเลิก', ['site/profile'], [
            ...
            <div class="card border-0 shadow-sm mt-3">
                <div class="card-body">
                    <h6 class="text-muted mb-3">
                        <i class="bi bi-shield-check me-2"></i>คำแนะนำด้านความปลอดภัย
                    </h6>
